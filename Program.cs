        ...
        public class NoteBook
        {
            ...
            static public void command()
            {
                ...
                { 
                    ...
                    a = Console.ReadLine();
                    if (string.Equals(a, "Добавить", StringComparison.CurrentCultureIgnoreCase))
                    {
                        NoteBook.addNewPerson();
                    }
                    if (string.Equals(a, "Удалить", StringComparison.CurrentCultureIgnoreCase))
                    {
                        Console.Write("Укажите индекс контакта, который вы хотите удалить: ");
                        NoteBook.deletePerson(Person);
                    }
                    if (string.Equals(a, "Показать", StringComparison.CurrentCultureIgnoreCase))
                    {
                    ...
                    if (string.Equals(a, "Показать всех", StringComparison.CurrentCultureIgnoreCase))
                    {
                        NoteBook.showAll();
                    }
                    if (string.Equals(a, "Редактировать", StringComparison.CurrentCultureIgnoreCase))
                    {
                    ...
                    if (string.Equals(a, "Команды", StringComparison.CurrentCultureIgnoreCase))
                    {
                        Console.WriteLine("Что бы добавить новый контакт напишите: Добавить");
                        Console.WriteLine("Что бы удалить контакт напишите: Удалить");
                        Console.WriteLine("Что бы увидеть контакт напишите: Показать");
